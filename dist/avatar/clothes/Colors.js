...
var Black = makeColor('Changemaker Black', '#262E33');
var Orange = makeColor('Changemaker Orange', '#e57200');
var GBlue = makeColor('Georgian Blue', '#004b87');
var GGreen = makeColor('Georgian Green', '#64a70b');
...
var Colors = /** @class */ (function (_super) {
    ...
    Colors.prototype.render = function () {
        return (React.createElement(options_1.Selector, { option: options_1.ClotheColorOption, defaultOption: Gray01 },
            ...
            React.createElement(GGreen, { maskID: this.props.maskID }),
